...
public class EffectCompoundPresets {
    public static EffectCompoundFunction MIN = (currentValue, effect) -> Math.min(currentValue, effect.getValue());
    public static EffectCompoundFunction MAX = (currentValue, effect) -> Math.max(currentValue, effect.getValue());
